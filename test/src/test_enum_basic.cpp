...
TEST(Enum, Basic) {
  ...
  EXPECT_THAT(fmt::format("{}", Color1::GREEN), StrEq("GREEN"));
  EXPECT_THAT(fmt::format("{}", GREEN), StrEq("GREEN"));
  EXPECT_THAT(fmt::format("{}", L), StrEq("L"));
  EXPECT_THAT(fmt::format("{}", Number1::one), StrEq("one"));
  EXPECT_THAT(fmt::format("{}", Number2::one), StrEq("one"));
  EXPECT_THAT(fmt::format("{}", Number3::one), StrEq("one"));
  EXPECT_THAT(fmt::format("{}", Binary::ONE), StrEq("ONE"));
  EXPECT_THAT(fmt::format("{}", space::rangers::humans), StrEq("humans"));
  EXPECT_THAT(fmt::format("{}", vc), StrEq(R"([RED, GREEN, BLUE])"));
  EXPECT_THAT(fmt::format("{}", mc), HasSubstr(R"(RED: [one, two], GREEN: [three], BLUE: [many])"));
...
auto format_as(const X::direction3 obj) {
...
auto format_as(const Color1 obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const Color2 obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const Color3 obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const Number1 obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const Directions obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const Number2 obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const crc_hack obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const crc_hack_2 obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const MaxUsedAsInvalid obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const Binary obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const Number3 obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
...
auto format_as(const space::rangers obj) {
  fmt::string_view name = "<unknown>";
  switch (obj) {
